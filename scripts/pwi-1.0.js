...
var pwi_username = "112992630280449572359";//;"Peregrinos santo cristo"; 			//Your username at Picasa WebAlbums
...
var pwi_album_only = "2013";				//setup with ONE specific album only, choose an album and take the name from the url between "#" and the last "/1"
var pwi_album_thumbsize = 144;			//supported sizes: 32, 48, 64, 72, 144, 160 (http://code.google.com/apis/picasaweb/reference.html#Parameters)
...
$(document).ready(function() {
	if (pwi_username == "YOUR_USER_NAME_HERE") {
